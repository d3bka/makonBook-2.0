...
# Add background to .reference-header
css = re.sub(
    r"\.reference-header\s*{[^}]*}",
    ".reference-header {\n    padding: 16px 18px;\n    display: flex;\n    align-items: center;\n    font-size: 20px;\n    font-weight: 700;\n    background: var(--sat-shell, var(--mk-surface-soft, #f7f7fb));\n    color: var(--sat-text, var(--mk-text, #161323));\n    border-bottom: 1px solid var(--sat-border, var(--mk-card-border, #e5e7eb));\n}",
    css
)
